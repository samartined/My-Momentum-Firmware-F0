...
typedef struct _PB_Gui_SendAsciiEventRequest {
    uint32_t value;
} PB_Gui_SendAsciiEventRequest;
...
#define PB_Gui_SendAsciiEventRequest_init_default {0}
...
#define PB_Gui_SendAsciiEventRequest_init_zero   {0}
...
#define PB_Gui_ScreenFrame_bg_color_tag          3
#define PB_Gui_ScreenFrame_fg_color_tag          4
#define PB_Gui_SendInputEventRequest_key_tag     1
#define PB_Gui_SendInputEventRequest_type_tag    2
#define PB_Gui_SendAsciiEventRequest_value_tag   1
...
X(a, STATIC,   SINGULAR, UINT32,   bg_color,          3) \
X(a, STATIC,   SINGULAR, UINT32,   fg_color,          4)
...
#define PB_Gui_SendAsciiEventRequest_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   value,             1)
#define PB_Gui_SendAsciiEventRequest_CALLBACK NULL
#define PB_Gui_SendAsciiEventRequest_DEFAULT NULL
...
extern const pb_msgdesc_t PB_Gui_SendAsciiEventRequest_msg;
...
#define PB_Gui_SendAsciiEventRequest_fields &PB_Gui_SendAsciiEventRequest_msg
...
#define PB_GUI_GUI_PB_H_MAX_SIZE                 PB_Gui_SendAsciiEventRequest_size
#define PB_Gui_SendAsciiEventRequest_size        6
